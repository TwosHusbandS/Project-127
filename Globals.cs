            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case PageStates.Settings:
                        ...
                        MainWindow.MW.btn_BloatDebloat.Style = Application.Current.FindResource("btn_hamburgeritem") as Style;
                        break;
                    ...
                    case PageStates.ComponentManager:
                        ...
                        MainWindow.MW.btn_BloatDebloat.Style = Application.Current.FindResource("btn_hamburgeritem") as Style;
                        break;
                    case PageStates.BloatDebloat:
                        MainWindow.MW.Frame_Main.Content = new BloatDebloat();
                        MainWindow.MW.btn_BloatDebloat.Style = Application.Current.FindResource("btn_hamburgeritem_selected") as Style;
