...
string lpSymlinkFileName, string lpTargetFileName, SymbolicLink dwFlags);
        ...
        public static DateTime GetCreationDate(string pFilePath, bool UTC = false)
        {
            ...
            if (doesFileExist(pFilePath))
            {
                ...
                catch
                {
                    ...
                    PopupWrapper.PopupError("Getting Creation Date of File: '" + pFilePath + "' failed.");
                }
            }
            return creation;
        }
        ...
        public static DateTime GetLastModifiedFolderDate(string pPath, bool UTC = false)
        {
            ...
            if (doesPathExist(pPath))
            {
                ...
                catch
                {
                    ...
                    PopupWrapper.PopupError("Getting LastModified Date of Path: '" + pPath + "' failed.");
                }
            }
            return creation;
        }
        ...
        public static DateTime GetLastWriteDate(string pFilePath, bool UTC = false)
        {
            ...
            if (doesFileExist(pFilePath))
            {
                ...
                catch
                {
                    ...
                    PopupWrapper.PopupError("Getting LastModified Date of File: '" + pFilePath + "' failed.");
                }
            }
            return creation;
        }
        ...
        public static void HardLinkFiles(string pLinkFilePath, string pRealFilePath, bool RaiseException = false)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    PopupWrapper.PopupError("Creating Hardlink in: '" + pLinkFilePath + "' for existing file '" + pRealFilePath + "' failed.\nI suggest you restart the Program (maybe Repair) and contact me if it happens again.\n\nErrorMessage:\n" + e.ToString());
                }
            }
        }
        ...
        public static void moveFile(string pMoveFromFilePath, string pMoveToFilePath, bool RaiseException = false)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    PopupWrapper.PopupError("Moving File: '" + pMoveFromFilePath + "' to '" + pMoveToFilePath + "' failed.\nI suggest you restart the Program and contact me if it happens again.\n\nErrorMessage:\n" + e.ToString());
                }
            }
        }
        ...
        public static void movePath(string Source, string Dest, bool RaiseException = false)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    PopupWrapper.PopupError("Moving Path: '" + Source + "' to '" + Dest + "' failed.\nI suggest you restart the Program and contact me if it happens again.\n\nErrorMessage:\n" + e.ToString());
                }
            }
        }
        ...
        public static void AddToDebug(string pLineContent)
        {
            ...
            HelperClasses.FileHandling.AddToDebugWrite(pLineContent);
            mut2.ReleaseMutex();
        }
        ...
        public static void AddToDebugWrite(string pLineContent)
        {
            ...
            {
                PopupWrapper.PopupError("Writing to Debug failed. File was probably deleted after start of Program.\nI suggest you restart the Program and contact me if it happens again.\n\nErrorMessage:\n" + e.ToString());
            }
        }
        ...
        public static void AddToLog(string pFilePath, string pLineContent)
        {
            ...
            {
                PopupWrapper.PopupError("Writing to Log failed. File was probably deleted after start of Program.\nI suggest you restart the Program and contact me if it happens again.\n\nErrorMessage:\n" + e.ToString());
        ...
        public static string CreateDirectoryMd5(string srcPath)
        {
            if (!doesPathExist(srcPath))
            {
                ...
                PopupWrapper.PopupError("Could not find some of the Paths we use to keep track of GTA Files.");
                Environment.Exit(5);
            }
        ...
        public async static Task<string> GetStringFromURL(string pURL, bool surpressPopup = false)
        {
            ...
            //Globals.DebugPopup("StartupInvestigation - X - GetStringFromURL DONE and rtrn.Length = " + rtrn.Length);
            return rtrn;
        }
        ...
        public static void RenameFile(string pFilePathSource, string pFileNameDest)
        {
            if (doesFileExist(pFilePathSource))
            {
                ...
                {
                    PopupWrapper.PopupError("Renaming File failed ('" + pFilePathSource + "' to '" + pFilePathDest + "').\nI suggest you restart the Program and contact me if it happens again.\n\nErrorMessage:\n" + e.ToString());
        ...
        public static void deleteFile(string pFilePath, bool ShowErrorAsPopup = true, bool RaiseException = false)
        {
            ...
            catch (Exception e)
            {
                ...
                else
                {
                    if (ShowErrorAsPopup)
                    {
                        PopupWrapper.PopupError("Deleting File failed ('" + pFilePath + "').\nI suggest you restart the Program and contact me if it happens again.\n\nErrorMessage:\n" + e.ToString());
                    }
                }
            }
        }
        ...
        public static void createFile(string pPath, string pFile, bool RaiseException = false)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    PopupWrapper.PopupError("Create File failed ('" + PathCombine(pPath, pFile) + "').\nI suggest you restart the Program and contact me if it happens again.\n\nErrorMessage:\n" + e.ToString());
                }
            }
        }
        ...
        public static void CreateAllZIPPaths(string pZIPFileExtractLocation)
        {
            ...
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles124");
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles129");
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles\update");
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles124\update");
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles129\update");
            ...
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles_Alternative\rockstar\129\");
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles_Alternative\rockstar\129\update\");
            ...
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles_Alternative\steam\129\");
            HelperClasses.FileHandling.createPath(pZIPFileExtractLocation.TrimEnd('\\') + @"\Project_127_Files\DowngradeFiles_Alternative\steam\129\update\");
